...
import com.andriawan24.pawpalace.data.models.ChatPerson
...
@HiltViewModel
class ChatListVM @Inject constructor(): ViewModel() {
                    ...
                    snapshots.documents.map { document ->
                        ...
                        ChatModel(
                            ...
                            sender = ChatPerson(
                                ...
                                displayPicture = sender?.get("displayPicture").toString()
                            ),
                            receiver = ChatPerson(
                                id = receiver?.get("id").toString(),
                                name = receiver?.get("name").toString(),
                                displayPicture = receiver?.get("displayPicture").toString()
                            ),
